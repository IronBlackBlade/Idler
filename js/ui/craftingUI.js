  ...
  return `
        <div class="crafting-weapon-damage-comparison">
            ...
            <div class="crafting-weapon-damage-row">
                ...
                <strong>
                    ${equippedWeapon?.name || "Brak"}
                    ${equippedWeapon ? equippedDamage : 0}
                </strong>
            </div>
...
function getCraftingEquipmentSetContextModel(
  ...
  const inventoryQuantity =
    typeof getCraftingItemQuantity === "function"
      ? getCraftingItemQuantity(resultItem.id)
      : 0;

  const isEquipped =
    typeof getEquippedCraftingItemQuantity === "function"
      ? getEquippedCraftingItemQuantity(resultItem.id) > 0
