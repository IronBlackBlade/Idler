...
const savedBlacksmithSubcategory =
  localStorage.getItem(
    "idler_blacksmith_subcategory",
  );

let currentBlacksmithSubcategory =
  savedBlacksmithSubcategory || "all";
...
const savedMaterialsSubcategory =
  localStorage.getItem(
    "idler_materials_subcategory",
  );

let currentMaterialsSubcategory =
  savedMaterialsSubcategory || "all";
...
function getMaterialsSubcategory(recipe) {
  if (!recipe) {
    return null;
  }
...
function setMaterialsSubcategory(
  subcategoryId,
) {
  const subcategoryExists =
    materialsSubcategories.some(
      (subcategory) => {
        return (
          subcategory.id ===
          subcategoryId
...
function getBlacksmithSubcategory(recipe) {
  if (!recipe) {
    return null;
  }
  ...
  return (
    resultItem.weaponClass ||
    recipe.subcategory ||
    null
  );
}

function setBlacksmithSubcategory(
  subcategoryId,
) {
  const subcategoryExists =
    blacksmithSubcategories.some(
      (subcategory) => {
        return (
          subcategory.id ===
          subcategoryId
...
const craftingSubcategoryConfigs = {
  ...
  materials: {
    ...
    getSubcategory:
      getMaterialsSubcategory,

    setSubcategory:
      setMaterialsSubcategory,
  },
  armorer: {
    subcategories:
  ...
  blacksmith: {
    subcategories:
      blacksmithSubcategories,
    getCurrentSubcategory: () =>
      currentBlacksmithSubcategory,
    getSubcategory:
      getBlacksmithSubcategory,
    setSubcategory:
      setBlacksmithSubcategory,
  },
