...
function restoreLastOpenedScreen() {
    const savedScreenId =
        localStorage.getItem(
            "idler_last_screen"
        );
    ...
    const screenId =
        savedScreenId &&
            document.getElementById(savedScreenId)
            ? savedScreenId
            : fallbackScreenId;

    if (
        screenId === "screen-tavern" &&
        typeof openTavernScreen === "function"
    ) {
        openTavernScreen();
        return;
    }
    ...
    if (
        screenId === "screen-alchemy" &&
        typeof openAlchemyScreen === "function"
    ) {
        openAlchemyScreen();
        return;
    }
    ...
    if (
        screenId === "screen-cooking" &&
        typeof openCookingScreen === "function"
    ) {
        openCookingScreen();
        return;
    }
    ...
    if (
        screenId === "screen-mining-locations" &&
        typeof openMiningScreen === "function"
    ) {
        openMiningScreen();
        return;
    }
    ...
    if (
        screenId === "screen-herbalism-locations" &&
        typeof openHerbalismScreen === "function"
    ) {
        openHerbalismScreen();
        return;
    }
    ...
    if (
        screenId === "screen-fishing-locations" &&
        typeof openFishingScreen === "function"
    ) {
        openFishingScreen();
        return;
    }
