const fishingAreas = [
  {
    id: "forest_pond",
    name: "Leśny staw",
    description: "Spokojne łowisko dobre dla początkujących wędkarzy.",
  ...
  },
  {
    ...
    description: "Ciemne wody jaskini skrywają ślepe ryby i kryształowe okazy.",
    ...
    treasureDrops: [{ itemId: "sunken_lockbox", weight: 100, fishingExp: 125 }],
  },
  {
    id: "sunken_ruins",
    ...
    treasureDrops: [{ itemId: "coral_relic", weight: 100, fishingExp: 200 }],
  },
  {
    id: "ice_hole",
  ...
  },
  {
    ...
    description: "Wrzące źródło pełne ryb zahartowanych przez ogień i magmę.",
    ...
    treasureDrops: [{ itemId: "volcanic_cache", weight: 100, fishingExp: 500 }],
  },
];
...
const fishingBaits = [
  {
    itemId: "worm_bait",
    icon: "🪱",
    effectDescription: "+5% szansy na rzadką rybę",
    rareChanceBonus: 5,
  ...
  },
  {
    itemId: "royal_grub",
    icon: "🐛",
    effectDescription: "+20% do rozmiaru złowionych ryb",
    rareChanceBonus: 0,
    treasureChanceBonus: 0,
    sizeBonus: 20,
    shopPrice: 20,
  },
  {
    ...
    icon: "🧲",
    effectDescription: "+2% szansy na wyłowienie skarbu",
    rareChanceBonus: 0,
...
const fishingOrders = [
  {
    ...
    description: "Karczmarz potrzebuje świeżych ryb na dzisiejszą kolację.",
    icon: "🍲",
    requiredFishingLevel: 1,
    requirements: [
  ...
  },
  {
    ...
    description: "Badacz chce porównać gatunki żyjące bez dostępu do światła.",
    icon: "🔬",
    requiredFishingLevel: 10,
    requirements: [
  ...
  },
  {
    ...
    description: "Ekspedycja zamawia solidny zapas ryb przed kolejną wyprawą.",
    icon: "🏺",
    requiredFishingLevel: 20,
    requirements: [
  ...
  },
  {
    ...
    description: "Strażnicy potrzebują pożywienia odpornego na długie mrozy.",
    icon: "🏔️",
    requiredFishingLevel: 35,
    requirements: [
  ...
  },
  {
    ...
    description: "Mistrz kuchni płaci fortunę za ryby zahartowane w magmie.",
    icon: "🌋",
    requiredFishingLevel: 50,
    requirements: [
