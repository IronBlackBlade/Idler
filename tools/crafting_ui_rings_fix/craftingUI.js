...
function getCraftingCategory(recipe) {
  ...
  // Najpierw rozpoznajemy specjalne typy wyposażenia.
  // Dzięki temu nawet błędna/nieobecna wartość recipe.category
  // nie może schować pierścieni, amuletów ani talizmanów.
  if (resultItem.type === "ring") {
    return "jeweler";
  }
...
function renderArmorerSubcategoryTabs(
  container,
) {
  if (
  ...
  armorerSubcategories.forEach(
    (subcategory) => {
      const recipesCount =
        subcategory.id === "all"
          ? armorerRecipes.length
          : armorerRecipes.filter(
            (recipe) => {
              return (
...
function renderTannerSubcategoryTabs(
  container,
) {
  if (
    currentCraftingCategory !==
  ...
  tannerSubcategories.forEach(
    (subcategory) => {
      const recipesCount =
        subcategory.id === "all"
          ? tannerRecipes.length
          : tannerRecipes.filter(
            (recipe) => {
              return (
...
function renderBowyerSubcategoryTabs(
  container,
) {
  if (
    currentCraftingCategory !==
  ...
  bowyerSubcategories.forEach(
    (subcategory) => {
      const recipesCount =
        subcategory.id === "all"
          ? bowyerRecipes.length
          : bowyerRecipes.filter(
              (recipe) => {
                return (
...
function renderArcanistSubcategoryTabs(
  container,
) {
  if (
    currentCraftingCategory !==
  ...
  arcanistSubcategories.forEach(
    (subcategory) => {
      const recipesCount =
        subcategory.id === "all"
          ? arcanistRecipes.length
          : arcanistRecipes.filter(
              (recipe) => {
                return (
...
function renderJewelerSubcategoryTabs(
  container,
) {
  if (
    currentCraftingCategory !==
  ...
  jewelerSubcategories.forEach(
    (subcategory) => {
      const recipesCount =
        subcategory.id === "all"
          ? jewelerRecipes.length
          : jewelerRecipes.filter(
              (recipe) => {
                return (
...
`;
  ...
  renderArmorerSubcategoryTabs(
    container,
  );

  renderTannerSubcategoryTabs(
    container,
  );

  renderBowyerSubcategoryTabs(
  container,
);

renderArcanistSubcategoryTabs(
  container,
);

renderJewelerSubcategoryTabs(
  container,
);
  ...
  visibleCraftingCategories.forEach((category) => {
    ...
    if (
      category.id === "armorer" &&
      currentArmorerSubcategory !== "all"
    ) {
      categoryRecipes =
        categoryRecipes.filter((recipe) => {
          return (
            getArmorerSubcategory(recipe) ===
            currentArmorerSubcategory
          );
        });
    }
    ...
    if (
  category.id === "tanner" &&
  currentTannerSubcategory !== "all"
) {
  categoryRecipes =
    categoryRecipes.filter((recipe) => {
      return (
        getTannerSubcategory(recipe) ===
        currentTannerSubcategory
      );
    });
}
...
if (
  category.id === "bowyer" &&
  currentBowyerSubcategory !== "all"
) {
  categoryRecipes =
    categoryRecipes.filter((recipe) => {
      return (
        getBowyerSubcategory(recipe) ===
        currentBowyerSubcategory
      );
    });
}
...
if (
  category.id === "arcanist" &&
  currentArcanistSubcategory !== "all"
) {
  categoryRecipes =
    categoryRecipes.filter((recipe) => {
      return (
        getArcanistSubcategory(recipe) ===
        currentArcanistSubcategory
      );
    });
}
...
if (
  category.id === "jeweler" &&
  currentJewelerSubcategory !== "all"
) {
  categoryRecipes =
    categoryRecipes.filter((recipe) => {
      return (
        getJewelerSubcategory(recipe) ===
        currentJewelerSubcategory
      );
    });
}
